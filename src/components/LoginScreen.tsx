export default function LoginScreen() {
  return (
    <div className="login-screen">
      ...
      <h1>gheart</h1>
      <p>
        Tinder for pull request reviews. Sign in, pick a repo, and start swiping — right to
        approve, left to request changes.
      </p>
      <a className="github-login" href="/api/auth/login">
